...
function SemanticProposalEditor({ item, onChange, notify }: { item: SemanticCandidate; onChange: (semantic: SemanticSnapshot) => void; notify: (m: string) => void }) {
